...
int main() {
    ...
    cin >> use_program;
    if (use_program == "yes") {
        cout << "Is there current inventory?" << endl
             << "Enter: yes or no" << endl;
        string is_there_inventory;
        cin >> is_there_inventory;
        if (is_there_inventory == "yes") {
            string file;
            ...
            cout << "What size would you like the shelter to be?" << endl;
            cin >> size;
